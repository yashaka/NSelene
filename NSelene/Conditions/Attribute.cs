...
namespace NSelene
{
    ...
    public static partial class Have
    {
        ...
        {
            public static Conditions.Condition<SeleneElement> Attribute(string name, string value) => new Conditions.NoAttribute(name, value);
            public static Conditions.Condition<SeleneElement> Value(string expected) => new Conditions.Not<SeleneElement>(new Conditions.Attribute("value", expected));
        }
